...
In groups of 3-4 people, you will use a chatbot to support a small research project from planning through analysis.

Do not to let the chatbot do the research for you. Decide what to ask, write or adapt the code, run it yourself, and check the results.
...
Translate the research question into a small, concrete computational task.

- Write a short plan: the question, proposed methodological approach, key steps, and expected end-result.
...
Each track includes a `post_doc_code` file: code left by a fictional postdoc from your lab or department. The fictional postdoc used that code for a similar, but different analysis. The goal of this section is for you to use AI to work with someone else's code.
...
Use the clean data to answer the research question.
...
- how it went working with AI (what you learned, any best practices you used, etc.).
